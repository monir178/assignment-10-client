...
const Navbar = () => {
    ...
    const { handleDark } = useContext(ThemeContext);
    ...
    return (
        <div className="bg-base-100 sticky z-10 top-0 drop-shadow-lg mb-4">
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-center justify-center space-x-4 ">
                            ...
                            {
                                user?.uid ?
                                    <button onClick={handleLogOut} className="btn-sm rounded-lg  text-white text-lg font-bold ring-2 ring-red-500/50 bg-red-500">Logout</button>
                                    :

                                    <NavLink
                                        className="btn-sm rounded-lg  text-white text-lg font-bold bg-gradient-to-r from-cyan-500 to-blue-700"
                                        to="/login"
                                        style={({ isActive }) => {
                                            return {
                                                fontWeight: isActive ? "bold" : "",
