            ...
            <div className='flex flex-col lg:flex-row justify-between lg:items-center' >
                ...
                <div className='mt-4 lg:mt-8 w-auto text-left mx-4 lg:mr-8 lg:ms-0  ' data-aos="fade-left">
                    ...
                    <ul className='list-disc list-outside ' >
                        ...
                        <li className='mb-4 ms-4 text-gray-700 text-base font-semibold'>They bring a wealth of real-world experience to the classroom, having worked on a variety of projects in the tech industry.</li>
                        <li className='mb-4 ms-4 text-gray-700 text-base font-semibold'>Our tutors are passionate about sharing their knowledge and expertise with learners, and they take a personalized approach to teaching.</li>
                        <li className='mb-4 ms-4 text-gray-700 text-base font-semibold'>They stay up-to-date on the latest trends and technologies, ensuring that learners receive the most relevant and current information.</li>
                    </ul>
                </div>
            </div>
